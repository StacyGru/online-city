    ...
    return (
        <div>
            ...
            <div className="flex gap-10 justify-center">
                <Link to="/system_units" className="p-5 w-1/4 lg:w-1/5 aspect-square square bg-mainWhite drop-shadow-sm rounded-xl text-center flex flex-col justify-center items-center">
                    <img src={SystemUnit} className="h-4/5"/>
                    <h1 className="text-lg lg:text-2xl">Системные блоки</h1>
                </Link>
                <Link to="/computer_kits" className="p-5 w-1/4 lg:w-1/5 aspect-square square bg-mainWhite drop-shadow-sm rounded-xl text-center flex flex-col justify-center items-center">
